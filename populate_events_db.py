...
def create_events(session):
    ...
    event_lookup = {}
    event_lookup['outdoors'] = [('camping', '2017-10-6', '18:30', '2017-10-8', '10:45'),
                                ('hiking', '2017-10-7', '11:45', '2017-10-7', '17:00'),
                                ('beach', '2017-10-14', '8:30', '2017-10-14', '15:15'),
                                ('park', '2017-10-21', '2:15', '2017-10-21', '6:00')]
    event_lookup['fitness'] = [('saturday morning group run', '2017-9-30', '7:00', '2017-9-30', '9:00'),
    ...
    event_lookup['games'] = [('game day', '2017-10-22', '13:15', '2017-10-22', '19:45'),
                             ('board game night', '2017-10-14', '17:00', '2017-10-14', '23:00'),
                             ('US Open', '2017-8-28', '00:00', '2017-9-1', '23:59')]
    event_lookup['music'] = [('concert', '2017-11-3', '20:00', '2017-11-3', '24:00')]
    event_lookup['film'] = [('movies', '2017-12-15', '18:00', '2017-12-15', '20:45')]
    event_lookup['food'] = [('birthday dinner', '2017-11-25', '18:45', '2017-11-25', '21:45'),
                            ('Brooklyn Bridge Park BBQ', '2017-10-27', '18:15', '2017-10-27', '19:30')]
    event_lookup['drink'] = [('happy hour', '2017-10-26', '17:00', '2017-10-26', '18:00')]
    event_lookup['shopping'] = [('back to school sale', '2017-8-14', '00:00', '2017-8-28', '23:59')]
    ...
    for activity_entry in activities:
        ...
        for event in events:
            new_event = Event(name='{}'.format(event[0]),
